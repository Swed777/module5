...
experience_score = int(input('Введите число очков опыта: '))
print('__________________')
if experience_score < 1000:
    print('Ваш уровень: ', 1)
elif experience_score >= 1000 and experience_score < 2500:
    print('Ваш уровень: ', 2)
elif experience_score >= 2500 and experience_score < 5000:
    print('Ваш уровень: ', 3)
else:
    print('Ваш уровень: ', 4)
